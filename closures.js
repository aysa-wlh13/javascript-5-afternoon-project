...
const inner = new outer();// Code Here
...
//Code Here
const callJake = new callFriend('Jake', 435-555-9248)
...
function secretNumber() {
  ...
  return {
    addToSecret: function(added){
      return secret += added;
    },
    
    takeAwayFromSecret: function(taken){
      return secret -= taken;
    }// Code here
  };
}
